...
<section class="publicMian ">
    ...
    <div class="right">
        ...
        <div class="providerAdd">
           <form method = "post" action="BillRegisterServlet">
                <div class="">
                ...
                <div>
                    <label for="billprovider">供应商：</label>
                    <input type="text" name="billprovider" id="billprovider" required/>
                </div>
                <div>
                    <label >是否付款：</label>
                    <input type="radio" name="zhifu"checked value="non-payment" />未付款
                    <input type="radio" name="zhifu" value="paid"/>已付款
                </div>
